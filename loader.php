...
require_once "Controller/problemaController";
require_once "Controller/solucaoController";
...
require_once "Model/subcategorias";

require_once "View/BaseConhecimento/baseConhecimento.php";
require_once "View/Cadastrar/Cadastrar.php";
require_once "View/Login/Login.php";
require_once "View/Principal/principal.php";
require_once "View/Resultado/resultado.php";
